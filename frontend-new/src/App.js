...
import { BrowserRouter as Router, Routes, Route, Link } from 'react-router-dom'; // Routing ke liye
import Admin from './Admin'; // Jo Admin.js file aapne banayi hai
import './App.css'; 
import 'bootstrap/dist/css/bootstrap.min.css';

const API_BASE_URL = "https://smart-agency-api.vercel.app";

// --- Alag Component: Menu Page taaki code saaf rahay ---
const MenuPage = ({ menu, cart, addToCart, handleCheckout, showLocation, setShowLocation, loading }) => (
    ...
    <nav className="navbar navbar-light bg-light shadow-sm p-3 sticky-top">
      <div className="container d-flex justify-content-between align-items-center">
        ...
        <div className="d-flex align-items-center">
           <Link to="/admin" className="btn btn-sm btn-outline-dark me-3">Admin Panel</Link>
